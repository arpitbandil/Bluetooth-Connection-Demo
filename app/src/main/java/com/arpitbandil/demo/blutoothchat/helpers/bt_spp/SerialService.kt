package com.arpitbandil.demo.blutoothchat.helpers.bt_spp
...
import com.arpitbandil.demo.blutoothchat.MainActivity
import com.arpitbandil.demo.blutoothchat.R
import com.arpitbandil.demo.blutoothchat.helpers.Constants
...
class SerialService : Service(), SerialListener {
    internal inner class SerialBinder : Binder() {
        val service = this@SerialService
    }
    ...
    private fun readQueue(queue: ArrayDeque<QueueItem>) {
        for (item in queue) {
            when (item.type) {
    ...
    private fun createNotification() {
        ...
        val restartIntent = Intent()
            .setClassName(this, MainActivity::class.java.simpleName)
